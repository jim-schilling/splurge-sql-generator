...
from jpy_sql_generator.sql_helper import detect_statement_type, FETCH_STATEMENT, EXECUTE_STATEMENT
...
def demonstrate_edge_cases():
    ...
    edge_cases = [
        ...
        ("INSERT INTO users (name) VALUES (:name) RETURNING id", "INSERT with RETURNING"),
