...
def test_from_env_overrides(monkeypatch):
    monkeypatch.setenv("SPLURGE_MAX_FILE_SIZE_MB", "123")
    ...
    assert cfg.max_file_size_mb == 123
...
def test_from_env_invalid_int(monkeypatch):
    monkeypatch.setenv("SPLURGE_MAX_FILE_SIZE_MB", "notanint")
